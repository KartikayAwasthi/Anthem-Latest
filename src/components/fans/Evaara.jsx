...
const Evaara = () => {
  return (
    <div className="bg-black text-white min-h-screen flex flex-col lg:flex-row items-center justify-between w-full overflow-hidden">
      ...
      >
        {/* Fan Name */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold">Evaara</h1>

        {/* Tagline */}
        <p className="text-lg sm:text-xl md:text-2xl text-[#ba6a5a] font-medium italic animate-pulse">
          Redefining Elegance in Motion
        </p>

        {/* Description */}
        <p className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed">
          Elevating comfort with sleek design and powerful performance.
          Built for modern homes with cutting-edge technology.
        </p>

...
const About = () => {
  ...
  return (
    <div className="relative bg-black text-white min-h-0 pt-32 pb-10 w-full overflow-hidden">
      ...
      <div
        ref={teamRef}
        className={`transition-opacity duration-1000 ease-in-out mt-28 px-4 md:px-12 ${inViewTeam ? "opacity-100" : "opacity-0"}`}
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 max-w-6xl mx-auto">
          {team.map((member, idx) => (
            <motion.div
              key={idx}
              className="bg-[#111111]/70 p-6 rounded-2xl shadow-lg border border-[#ba6a5a]/30 backdrop-blur-md hover:shadow-[0_0_30px_rgba(186,106,90,0.4)] transition-all"
              whileHover={{ scale: 1.05 }}
